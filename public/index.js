...
mapboxgl.accessToken = 'pk.eyJ1IjoicGhpbGljYSIsImEiOiJja3Z0N2xqdGMwYXR1MndqdGRla2F3OXZ4In0.llFTILdFUxQE4UBGwJn3AQ';
...
var directions = new MapboxDirections({
    accessToken: 'pk.eyJ1IjoicGhpbGljYSIsImEiOiJja3Z0N2xqdGMwYXR1MndqdGRla2F3OXZ4In0.llFTILdFUxQE4UBGwJn3AQ',
    unit: 'metric',
					...
					fetch(url_3)
						...
						.then(data => {	
							...
							if (duration_data >= 3600) {
									duration = Math.round((duration_data / 3600) * 100) / 100 + 'hr';
							} else {
							...
							const radioButtons = document.querySelectorAll('input[name="seatNumber"]');
							...
							document.getElementById("startselect").innerHTML = setStartingPoint;
